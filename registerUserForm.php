    ...
    <div id="userCategoryChoice">
        <div class="row center-align">
            <div class="col s6">
                ...
                <a href="Inscription-visiteur" class="userChoiceButton btn waves-effect waves-light lime darken-3">Cliquer ici</a>
            </div>
            <div class="col s6">
                <h3>Contributeur</h3>
                <p>Vous souhaitez ajouter un site touristique</p>
                <a href="Inscription-contributeur" class="userChoiceButton btn waves-effect waves-light lime darken-3">Cliquer ici</a>
            </div>
        </div>
    </div>
</div>
