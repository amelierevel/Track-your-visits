            ...
            <div class="container">
                <div class="row">
                    <div class="col l6 s12">
                        ...
                        <ul>
                            <li><a class="grey-text text-lighten-4" href="Accueil#visitorSection" title="Lien vers renseignements visiteur">Visiteur</a></li>
                            <li><a class="grey-text text-lighten-4" href="Accueil#contributorSection" title="Lien vers renseignements contributeur">Contributeur</a></li>
                            <li><a class="grey-text text-lighten-4" href="Accueil#placesSection" title="Lien vers renseignements sur les lieux à visiter">Lieux à visiter</a></li>
                        </ul>
                    </div>
