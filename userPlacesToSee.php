    ...
    <div class="col m10 offset-m1 s12">
        ...
        <div class="row center-align">
            ...
            if (isset($_SESSION['isConnect'])) { //vérification que l'utilisateur est connecté
                if (empty($placesToSeeList)) { //s'il n'a aucun lieu à voir enregistré affichage d'un message d'erreur
                    ?>
                    ...
                    <?php
                } else { // sinon l'utilisateur a des lieux à voir enregistrés et ils s'affichent
                        ...
                        <div class="card  col m4 s12">
                            ...
                            <div class="card-stacked">
                                <div class="card-content">
                                    <a href="A-voir?idPlaceDelete=<?= $placeDetail->idPlaceToSee ?>" class="btn-floating waves-effect waves-light red accent-4 secondary-content deleteButton" title="Lien pour la suppression du lieu"><i class="material-icons">delete</i></a>
                                    <?php
