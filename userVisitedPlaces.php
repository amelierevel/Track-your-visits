                ...
                <div class="card  col m4 s12">
                    ...
                    <div class="card-stacked">
                        <div class="card-content">
                            <a href="Mes-visites?idPlaceDelete=<?= $placeDetail->idVisitedPlace ?>" class="btn-floating waves-effect waves-light red accent-4 secondary-content"><i class="material-icons">delete</i></a>
                            <?php
